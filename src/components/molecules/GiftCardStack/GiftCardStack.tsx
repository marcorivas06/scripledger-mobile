...
interface GiftCardStackRenderItemProps{
 ...
 * @param stepOffset Minimum required vertical offset
 * @returns New vertical translation value
 */
const calculateTranslateY = ( index: number, scrollOffset: number, stepOffset = 60) => {
  'worklet';
